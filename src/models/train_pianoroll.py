...
if __name__=="__main__":
    ...
    H_PARAMS = {
        ...
        'PARENT_TRAIN_ID'       : 'ID_2022_01_23_12_35_21',#None,
        ...
        'LOSS_FACTOR_SEQUENCE'  : [
                                    ...
                                    {'R_LOSS_FACTOR':1000  ,'N_EPOCHS': 10},
                                    {'R_LOSS_FACTOR':1000  ,'N_EPOCHS': 10},
                                    {'R_LOSS_FACTOR':1000  ,'N_EPOCHS': 10},
                                    {'R_LOSS_FACTOR':1000  ,'N_EPOCHS': 10},
                                    {'R_LOSS_FACTOR':1000  ,'N_EPOCHS': 10},
                                    {'R_LOSS_FACTOR': 500  ,'N_EPOCHS': 10},
                                    {'R_LOSS_FACTOR': 500  ,'N_EPOCHS': 10},
                                    {'R_LOSS_FACTOR': 500  ,'N_EPOCHS': 10},
                                    {'R_LOSS_FACTOR': 500  ,'N_EPOCHS': 10},
                                    {'R_LOSS_FACTOR': 500  ,'N_EPOCHS': 10},
                                    {'R_LOSS_FACTOR': 250  ,'N_EPOCHS': 10},
                                    {'R_LOSS_FACTOR': 250  ,'N_EPOCHS': 10},
                                    {'R_LOSS_FACTOR': 250  ,'N_EPOCHS': 10},
                                    {'R_LOSS_FACTOR': 250  ,'N_EPOCHS': 10},
                                    {'R_LOSS_FACTOR': 250  ,'N_EPOCHS': 10},
                                    {'R_LOSS_FACTOR': 100  ,'N_EPOCHS': 10},
                                    {'R_LOSS_FACTOR': 100  ,'N_EPOCHS': 10},
                                    {'R_LOSS_FACTOR': 100  ,'N_EPOCHS': 10},
                                    {'R_LOSS_FACTOR': 100  ,'N_EPOCHS': 10},
                                    {'R_LOSS_FACTOR': 100  ,'N_EPOCHS': 10},
                                    {'R_LOSS_FACTOR':  50  ,'N_EPOCHS': 10},
                                    {'R_LOSS_FACTOR':  50  ,'N_EPOCHS': 10},
                                    {'R_LOSS_FACTOR':  50  ,'N_EPOCHS': 10},
                                    {'R_LOSS_FACTOR':  50  ,'N_EPOCHS': 10},
                                    {'R_LOSS_FACTOR':  50  ,'N_EPOCHS': 10},
                                    {'R_LOSS_FACTOR':  20  ,'N_EPOCHS': 10},
                                    {'R_LOSS_FACTOR':  20  ,'N_EPOCHS': 10},
                                    {'R_LOSS_FACTOR':  20  ,'N_EPOCHS': 10},
                                    {'R_LOSS_FACTOR':  20  ,'N_EPOCHS': 10},
                                    {'R_LOSS_FACTOR':  20  ,'N_EPOCHS': 10},
                                    {'R_LOSS_FACTOR':  10  ,'N_EPOCHS': 10},
                                    {'R_LOSS_FACTOR':  10  ,'N_EPOCHS': 10},
                                    {'R_LOSS_FACTOR':  10  ,'N_EPOCHS': 10},
                                    {'R_LOSS_FACTOR':  10  ,'N_EPOCHS': 10},
                                    {'R_LOSS_FACTOR':  10  ,'N_EPOCHS': 10},
