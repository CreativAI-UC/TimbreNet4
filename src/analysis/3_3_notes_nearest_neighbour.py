...
def model_nearest_neighbour_analysis(run_path, chord_3_notes, chord_3_latent, verbose=False):
    ...
    distances, indices = tree.query(chord_3_latent, 11)
    ...
    for i in range(n_3):
        chord_3 = chord_3_notes[i]

        nearest_0 = chord_3_notes[indices[i][1]]
        nearest_1 = chord_3_notes[indices[i][2]]
        nearest_2 = chord_3_notes[indices[i][3]]
        nearest_3 = chord_3_notes[indices[i][4]]
        nearest_4 = chord_3_notes[indices[i][5]]
        nearest_5 = chord_3_notes[indices[i][6]]
        nearest_6 = chord_3_notes[indices[i][7]]
        nearest_7 = chord_3_notes[indices[i][8]]
        nearest_8 = chord_3_notes[indices[i][9]]
        nearest_9 = chord_3_notes[indices[i][10]]
    ...
    for LATENT_DIM_PATH in LATENT_DIM_PATHS:
        ...
        for ARCHITECTURE_PATH in ARCHITECTURE_PATHS:
            ...
            for RUN_PATH in RUN_PATHS:
                ...
                result_txt += model_nearest_neighbour_analysis(RUN_PATH, chord_3_notes, chord_3_latent)

    with open(os.path.join(CODE_PATH, 'analysis_results/3_3_notes_nearest_neighbour/result.txt'), 'w') as text_file:
